...
if (!isset($element['admin_title'])) $element['admin_title'] = __('New','vowels-contact-form-with-drag-and-drop');
if (!isset($element['title'])) $element['title'] = '';
if (!isset($element['description'])) $element['description'] = '';
$helpUrl = vowels_form_builder_help_link('element-group');
?>
    ...
    <div class="ifb-top-element-wrap qfb-cf">
        ...
        <div class="ifb-element-preview ifb-element-preview-text">
                <div class="ifb-group-start">
                    <span class="ifb-group-start-text"><?php printf(esc_html(__('Start of group: %s','vowels-contact-form-with-drag-and-drop')), '<span class="ifb-start-group-name">' . $element['admin_title'] . '</span>'); ?></span>
                </div>
                <div class="ifb-group-start-wrap-user-text qfb-cf">
        ...
        <div class="ifb-element-settings-tabs" id="ifb-element-settings-tabs-<?php echo $id; ?>">
                ...
                <div class="ifb-element-settings-inner">
                    <table class="ifb-form-table ifb-element-settings-form-table ifb-element-settings-settings-form-table">
                        <tr valign="top">
                            <th scope="row">
                                <div class="ifb-tooltip"><div class="ifb-tooltip-content">
                                    <?php esc_html_e('The group name is only shown in the form builder to help you identify groups.','vowels-contact-form-with-drag-and-drop'); ?>
                                </div></div>
                                <label for="admin_title_<?php echo $id; ?>"><?php esc_html_e('Name','vowels-contact-form-with-drag-and-drop'); ?></label>
                            </th>
                            <td><input type="text" id="admin_title_<?php echo $id; ?>" name="admin_title_<?php echo $id; ?>" value="<?php echo esc_attr($element['admin_title']); ?>" onkeyup="vowelsforminc.updateGroupName(vowelsforminc.getElementById(<?php echo $id; ?>));" /></td>
                        </tr>
                        <?php if (!isset($element['show_name_in_email'])) $element['show_name_in_email'] = false; ?>
                        <tr valign="top">
                            <th scope="row">
                                <div class="ifb-tooltip"><div class="ifb-tooltip-content">
                                    <?php esc_html_e('Shows the group name as a sub-heading in the default notification email','vowels-contact-form-with-drag-and-drop'); ?>
                                </div></div>
                                <label for="show_name_in_email_<?php echo $id; ?>"><?php esc_html_e('Show name in email','vowels-contact-form-with-drag-and-drop'); ?></label></th>
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <div class="ifb-tooltip"><div class="ifb-tooltip-content">
                                    <?php esc_html_e('The title will appear at the top of your group','vowels-contact-form-with-drag-and-drop'); ?>
                                </div></div>
                                <label for="title_<?php echo $id; ?>"><?php esc_html_e('Title','vowels-contact-form-with-drag-and-drop'); ?></label></th>
                            <td><input type="text" id="title_<?php echo $id; ?>" name="title_<?php echo $id; ?>" value="<?php echo _wp_specialchars($element['title'], ENT_COMPAT, false, true); ?>" onkeyup="vowelsforminc.updateGroupTitle(vowelsforminc.getElementById(<?php echo $id; ?>));" /></td>
                        </tr>
            ...
            <div class="ifb-tabs-panel" id="ifb-element-settings-tab-more-<?php echo $id; ?>">
                ...
                <table class="ifb-form-table ifb-element-settings-form-table ifb-element-settings-more-form-table">
                    ...
                    <tr valign="top">
                        <th scope="row">
                            <div class="ifb-tooltip"><div class="ifb-tooltip-content">
                                ...
                                this number of elements, further elements will appear on the line below.','vowels-contact-form-with-drag-and-drop'); ?>
                            </div></div>
                            <label for="number_of_columns_<?php echo $id; ?>"><?php esc_html_e('Number of columns','vowels-contact-form-with-drag-and-drop'); ?></label></th>
                        <td>
                    ...
                    <tr valign="top">
                        <th scope="row">
                            <div class="ifb-tooltip"><div class="ifb-tooltip-content">
                                ...
                                spaced. %1$sFloat left%2$s - the columns are compacted left.', 'vowels-contact-form-with-drag-and-drop'), '<span class="ifb-bold">', '</span>'); ?>
                            </div></div>
                            <label for="column_alignment_<?php echo $id; ?>"><?php esc_html_e('Column alignment','vowels-contact-form-with-drag-and-drop'); ?></label></th>
                        <td>
                            <select id="column_alignment_<?php echo $id; ?>" name="column_alignment_<?php echo $id; ?>">
                                <option value="proportional" <?php selected($element['column_alignment'], 'proportional'); ?>><?php esc_html_e('Proportional','vowels-contact-form-with-drag-and-drop'); ?></option>
                                <option value="left" <?php selected($element['column_alignment'], 'left'); ?>><?php esc_html_e('Float left','vowels-contact-form-with-drag-and-drop'); ?></option>
                            </select>
                        </td>
                    </tr>
                    ...
                    <tr valign="top">
                        <th scope="row">
                            <div class="ifb-tooltip"><div class="ifb-tooltip-content">
                                ...
                                be inherited from the parent group.','vowels-contact-form-with-drag-and-drop'); ?>
                            </div></div>
                        ...
                        <td>
                            ...
                            <p class="description"><?php esc_html_e('Choose where to display the label relative to the input for the elements in this group. Changes to this setting will only be visible when viewing or previewing the form.','vowels-contact-form-with-drag-and-drop'); ?></p>
                        </td>
                    </tr>
                    ...
                    <tr valign="top">
                        <th scope="row">
                            <label for="group_style_<?php echo $id; ?>"><?php esc_html_e('Group style','vowels-contact-form-with-drag-and-drop'); ?></label>
                        </th>
                        <td>
                            <select id="group_style_<?php echo $id; ?>" name="group_style_<?php echo $id; ?>" onchange="vowelsforminc.groupStyleChanged(vowelsforminc.getElementById(<?php echo $id; ?>));">
                                <option value="plain" <?php selected($element['group_style'], 'plain'); ?>><?php esc_html_e('Plain','vowels-contact-form-with-drag-and-drop'); ?></option>
                                <option value="bordered" <?php selected($element['group_style'], 'bordered'); ?>><?php esc_html_e('Bordered','vowels-contact-form-with-drag-and-drop'); ?></option>
                            </select>
                            <p class="description"><?php esc_html_e('Plain groups have no additional styling. Bordered groups have a border and padding.','vowels-contact-form-with-drag-and-drop'); ?></p>
                        </td>
                    </tr>
                    ...
                    <tr valign="top" class="ifb-show-if-group-style-bordered <?php if ($element['group_style'] == 'plain') echo 'ifb-hidden'; ?>">
                        <th scope="row"><label for="border_colour_<?php echo $id; ?>"><?php esc_html_e('Border color','vowels-contact-form-with-drag-and-drop'); ?></label></th>
                    ...
                    <tr valign="top" class="ifb-show-if-group-style-bordered <?php if ($element['group_style'] == 'plain') echo 'ifb-hidden'; ?>">
                        <th scope="row"><label for="background_colour_<?php echo $id; ?>"><?php esc_html_e('Background color','vowels-contact-form-with-drag-and-drop'); ?></label></th>
