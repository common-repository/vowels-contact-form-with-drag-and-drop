...
if (!isset($element['label'])) $element['label'] = __('Password','vowels-contact-form-with-drag-and-drop');
...
$helpUrl = vowels_form_builder_help_link('element-password');
?>
    ...
    <div class="ifb-top-element-wrap qfb-cf">
        ...
        <div class="ifb-element-preview ifb-element-preview-password">
            ...
            <div class="ifb-preview-input">
                <input type="password" name="ifb_element_<?php echo $id; ?>" id="ifb_element_<?php echo $id; ?>" class="preview_form" value="<?php echo esc_attr($element['default_value']); ?>" disabled="disabled"<?php echo $element['placeholder'] !== '' ? ' placeholder="' . vowels_form_builder_escape($element['placeholder']) . '"' : ''; ?> />
