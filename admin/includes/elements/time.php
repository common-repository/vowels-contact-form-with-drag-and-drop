...
if (!isset($element['label'])) $element['label'] = __('Time','vowels-contact-form-with-drag-and-drop');
...
$hhString = strlen($element['hh_string']) ? $element['hh_string'] : _x('HH', 'select hour','vowels-contact-form-with-drag-and-drop');
$mmString = strlen($element['mm_string']) ? $element['mm_string'] : _x('MM', 'select minute','vowels-contact-form-with-drag-and-drop');
$ampmString = strlen($element['ampm_string']) ? $element['ampm_string'] : _x('am/pm', 'select morning/afternoon','vowels-contact-form-with-drag-and-drop');
$amString = strlen($element['am_string']) ? $element['am_string'] : _x('am', 'time, morning','vowels-contact-form-with-drag-and-drop');
$pmString = strlen($element['pm_string']) ? $element['pm_string'] : _x('pm', 'time, evening','vowels-contact-form-with-drag-and-drop');
...
$helpUrl = vowels_form_builder_help_link('element-time');
?>
	...
	<div class="ifb-top-element-wrap qfb-cf">
        ...
        <div class="ifb-element-preview ifb-element-preview-time">
            ...
            <div class="ifb-preview-input">
                <select id="ifb_element_<?php echo $id; ?>_hour" name="ifb_element_<?php echo $id; ?>[hour]" class="preview_form"  disabled="disabled">
            ...
            <div class="ifb-tabs-panel" id="ifb-element-settings-tab-more-<?php echo $id; ?>">
                <div class="ifb-element-settings-inner">
                    <table class="ifb-form-table ifb-element-settings-form-table ifb-element-settings-more-form-table">
                        ...
                        <tr valign="top">
                            <th scope="row"><label for="time_12_24_<?php echo $id; ?>"><?php esc_html_e('12/24 hour time','vowels-contact-form-with-drag-and-drop'); ?></label></th>
                            <td>
                                <select id="time_12_24_<?php echo $id; ?>" name="time_12_24_<?php echo $id; ?>" onchange="vowelsforminc.updateTimePreview(vowelsforminc.getElementById(<?php echo $id; ?>));">
                                    <option value="12" <?php selected($element['time_12_24'], '12'); ?>><?php esc_html_e('12 hour','vowels-contact-form-with-drag-and-drop'); ?></option>
                                    <option value="24" <?php selected($element['time_12_24'], '24'); ?>><?php esc_html_e('24 hour','vowels-contact-form-with-drag-and-drop'); ?></option>
                                </select>
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                                <div class="ifb-tooltip"><div class="ifb-tooltip-content">
                                    <?php esc_html_e('Shows the headings for HH, MM and am/pm as the first options in the dropdown menus.','vowels-contact-form-with-drag-and-drop'); ?>
                                </div></div>
                                <label for="show_time_headings_<?php echo $id; ?>"><?php esc_html_e('Show time headings','vowels-contact-form-with-drag-and-drop'); ?></label></th>
                            <td>
                                <input type="checkbox" id="show_time_headings_<?php echo $id; ?>" name="show_time_headings_<?php echo $id; ?>" <?php checked(true, $element['show_time_headings']); ?> onclick="vowelsforminc.showTimeHeadings(this.checked, vowelsforminc.getElementById(<?php echo $id; ?>));" />
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                                <div class="ifb-tooltip"><div class="ifb-tooltip-content">
                                    <?php esc_html_e('The start hour will be the first hour in the hour dropdown and every hour from the start hour to the end hour will be displayed.','vowels-contact-form-with-drag-and-drop'); ?>
                                </div></div>
                                <label for="start_hour_<?php echo $id; ?>"><?php esc_html_e('Start hour','vowels-contact-form-with-drag-and-drop'); ?></label></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row">
                                <div class="ifb-tooltip"><div class="ifb-tooltip-content">
                                    <?php esc_html_e('The end hour will be the last hour in the hour dropdown and every hour from the start hour to the end hour will be displayed.','vowels-contact-form-with-drag-and-drop'); ?>
                                </div></div>
                                <label for="end_hour_<?php echo $id; ?>"><?php esc_html_e('End hour','vowels-contact-form-with-drag-and-drop'); ?></label></th>
                            <td>
                        ...
                        <tr valign="top">
                            <th scope="row"><label><?php esc_html_e('Default value','vowels-contact-form-with-drag-and-drop'); ?></label></th>
                            <td>
                                <select id="default_value_<?php echo $id; ?>_hour" name="default_value_<?php echo $id; ?>[hour]" onchange="vowelsforminc.updateTimePreview(vowelsforminc.getElementById(<?php echo $id; ?>));">
                                    <?php if ($element['show_time_headings']) : ?><option value=""><?php echo esc_html($hhString); ?></option><?php endif; ?>
                                    <?php if ($sh > $eh) : ?>
                                        <?php for ($i = $sh; $i >= $eh; $i--) : ?>
                                            <?php $i = str_pad($i, 2, '0', STR_PAD_LEFT); ?>
                                ...
                                <select id="default_value_<?php echo $id; ?>_minute" name="default_value_<?php echo $id; ?>[minute]" onchange="vowelsforminc.updateTimePreview(vowelsforminc.getElementById(<?php echo $id; ?>));">
                                    <?php if ($element['show_time_headings']) : ?><option value=""><?php echo esc_html($mmString); ?></option><?php endif; ?>
                                    <?php foreach (range(0, 59) as $min) : ?>
                                        <?php if ($min % $element['minute_granularity'] == 0) : ?>
                                            <?php $min = str_pad($min, 2, '0', STR_PAD_LEFT); ?>
                                ...
                                <select id="default_value_<?php echo $id; ?>_ampm" name="default_value_<?php echo $id; ?>[ampm]" onchange="vowelsforminc.updateTimePreview(vowelsforminc.getElementById(<?php echo $id; ?>));" <?php if ($element['time_12_24'] == '24') echo 'class="ifb-hidden"'; ?>>
                                    <?php if ($element['show_time_headings']) : ?><option value=""><?php echo esc_html($ampmString); ?></option><?php endif; ?>
                                    <option value="am" <?php selected($element['default_value']['ampm'], 'am'); ?>><?php echo esc_html($amString); ?></option>
                                    <option value="pm" <?php selected($element['default_value']['ampm'], 'pm'); ?>><?php echo esc_html($pmString); ?></option>
                                </select>
                                <span class="ifb-refresh-default-value ifb-simple-tooltip" onclick="vowelsforminc.updateTimePreview(vowelsforminc.getElementById(<?php echo $id; ?>));" title="<?php esc_attr_e('Updates the default value options with your changes to other settings','vowels-contact-form-with-drag-and-drop'); ?>"><?php esc_html_e('Sync with changes','vowels-contact-form-with-drag-and-drop'); ?></span>
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
                                <div class="ifb-tooltip"><div class="ifb-tooltip-content">
                                    <?php esc_html_e('Determines how many minutes to show per hour. 1 will show all 60 minutes, 5 will show minutes at 5 minute intervals, 10 at 10 minute intervals and so on.','vowels-contact-form-with-drag-and-drop'); ?>
                                </div></div>
                                <label for="minute_granularity_<?php echo $id; ?>"><?php esc_html_e('Minute granularity','vowels-contact-form-with-drag-and-drop'); ?></label>
                            </th>
                            <td>
                                <select id="minute_granularity_<?php echo $id; ?>" name="minute_granularity_<?php echo $id; ?>" onchange="vowelsforminc.updateTimePreview(vowelsforminc.getElementById(<?php echo $id; ?>));">
                        ...
                        ?>
                        <tr valign="top">
                            <th scope="row"><label for="time_format_<?php echo $id; ?>"><?php esc_html_e('Time format','vowels-contact-form-with-drag-and-drop'); ?></label></th>
                            <td>
                                ...
                                <p class="description"><?php esc_html_e('The format of the time when displayed in the notification email and when viewing entries','vowels-contact-form-with-drag-and-drop'); ?></p>
                            </td>
                        </tr>
                        <?php $timeValidator = new vowelsforminc_Validator_Time();
                        if (!isset($element['time_validator_message_invalid'])) $element['time_validator_message_invalid'] = ''; ?>
                        <tr valign="top">
                            <th scope="row"><label for="time_validator_message_invalid_<?php echo $id; ?>"><?php esc_html_e('Error message if invalid time','vowels-contact-form-with-drag-and-drop'); ?></label></th>
                            <td>
                                ...
                                <p class="description"><?php printf(esc_html__('Translate or override the error message shown if the time is not valid. The default is "%s".', 'vowels-contact-form-with-drag-and-drop'), '<span class="ifb-bold">' . $timeValidator->getMessageTemplate('invalid') . '</span>'); ?></p>
                            </td>
                        </tr>
                        <tr valign="top">
                            ...
                            <td>
                                <table class="ifb-form-table ifb-form-subtable">
                                    <tr>
                                        <th scope="row"><?php echo esc_html(_x('HH', 'select hour','vowels-contact-form-with-drag-and-drop')); ?></th>
                                    ...
                                    <tr>
                                        <th scope="row"><?php echo esc_html(_x('MM', 'select minute','vowels-contact-form-with-drag-and-drop')); ?></th>
                                    ...
                                    <tr>
                                        <th scope="row"><?php echo esc_html(_x('am/pm', 'select morning/afternoon','vowels-contact-form-with-drag-and-drop')); ?></th>
                                    ...
                                    <tr>
                                        <th scope="row"><?php echo esc_html(_x('am', 'time, morning','vowels-contact-form-with-drag-and-drop')); ?></th>
                                    ...
                                    <tr>
                                        <th scope="row"><?php echo esc_html(_x('pm', 'time, evening','vowels-contact-form-with-drag-and-drop')); ?></th>
