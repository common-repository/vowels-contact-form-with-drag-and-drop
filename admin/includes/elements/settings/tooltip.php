...
<tr valign="top">
    <th scope="row">
        <div class="ifb-tooltip"><div class="ifb-tooltip-content">
            ...
            it with their mouse. You can customize the look of tooltips by going to %1$sSettings &rarr; Style &rarr; Tooltips%2$s', 'vowels-contact-form-with-drag-and-drop'), '<span class="ifb-bold">', '</span>'); ?>
        </div></div>
        <label for="tooltip_<?php echo $id; ?>"><?php esc_html_e('Tooltip text','vowels-contact-form-with-drag-and-drop'); ?></label>
    </th>
    <td>
...
%1$sHelp icon%2$s in the %1$sOptional%2$s settings tab, or in the global tooltip settings at %1$sSettings &rarr; Style &rarr; Tooltips%2$s.', 'vowels-contact-form-with-drag-and-drop'),
