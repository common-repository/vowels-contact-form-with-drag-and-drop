<?php if (!defined('VOWELSFORMDRAGDROP_VERSION')) exit; ?><div id="ifb-filter-wrap-<?php echo $filter['element_id']; ?>-<?php echo $filter['id']; ?>" class="ifb-filter ifb-filter-alphanumeric">
    ...
    <?php if (!isset($filter['name'])) $filter['name'] = _x('Alpha Numeric', 'the name of alphanumeric filter which filters out non-alphanumeric characters','vowels-contact-form-with-drag-and-drop'); ?>
