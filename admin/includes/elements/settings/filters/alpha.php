<?php if (!defined('VOWELSFORMDRAGDROP_VERSION')) exit; ?><div id="ifb-filter-wrap-<?php echo $filter['element_id']; ?>-<?php echo $filter['id']; ?>" class="ifb-filter ifb-filter-alpha">
    ...
    <?php if (!isset($filter['name'])) $filter['name'] = _x('Alpha', 'the name of alphabet filter which filters out non-alphabet characters','vowels-contact-form-with-drag-and-drop'); ?>
