<?php if (!defined('VOWELSFORMDRAGDROP_VERSION')) exit; ?><div id="ifb-validator-wrap-<?php echo $validator['element_id']; ?>-<?php echo $validator['id']; ?>" class="ifb-validator ifb-validator-digits">
    ...
    <?php if (!isset($validator['name'])) $validator['name'] = _x('Digits', 'the name of the digits validator which validates that the value contains only digits','vowels-contact-form-with-drag-and-drop'); ?>
    ...
    <div class="ifb-validator-settings">
        ...
        <table class="ifb-form-table ifb-validator-settings-form-table">
            <?php
                $digitsValidator = new vowelsforminc_Validator_Digits();
            ...
            <tr valign="top">
                <th scope="row">
                    ...
                    <label for="v_invalid_<?php echo $validator['element_id']; ?>_<?php echo $validator['id']; ?>"><?php echo esc_html($digitsValidator->getMessageTemplate('invalid')); ?></label></th>
