<?php if (!defined('VOWELSFORMDRAGDROP_VERSION')) exit; ?><div id="ifb-validator-wrap-<?php echo $validator['element_id']; ?>-<?php echo $validator['id']; ?>" class="ifb-validator ifb-validator-alphanumeric">
    ...
    <?php if (!isset($validator['name'])) $validator['name'] = _x('Alpha Numeric', 'the name of the alphanumeric validator which validates that the value contains only alphanumeric characters','vowels-contact-form-with-drag-and-drop'); ?>
    ...
    <div class="ifb-validator-settings">
        ...
        <table class="ifb-form-table ifb-validator-settings-form-table">
            <?php
                $alphanumericValidator = new vowelsforminc_Validator_AlphaNumeric();
