<?php if (!defined('VOWELSFORMDRAGDROP_VERSION')) exit; ?><div id="ifb-validator-wrap-<?php echo $validator['element_id']; ?>-<?php echo $validator['id']; ?>" class="ifb-validator ifb-validator-identical">
    ...
    <?php if (!isset($validator['name'])) $validator['name'] = _x('Identical', 'the name of the identical validator which validates that the value is identical to a value','vowels-contact-form-with-drag-and-drop'); ?>
    ...
    <div class="ifb-validator-settings">
                ...
                <th scope="row">
                    <div class="ifb-tooltip">
                        <div class="ifb-tooltip-content">
                            <?php esc_html_e('The token that the submitted value must be equal to, if not the error message shown below will be displayed to the user','vowels-contact-form-with-drag-and-drop'); ?>
                        </div>
                    </div>
                    <label for="v_token_<?php echo $validator['element_id']; ?>_<?php echo $validator['id']; ?>"><?php esc_html_e('Value','vowels-contact-form-with-drag-and-drop'); ?></label>
                </th>
        ...
        <table class="ifb-form-table ifb-validator-settings-form-table">
            <?php
                $identicalValidator = new vowelsforminc_Validator_Identical(array('token' => 1));
                ...
                <th scope="row">
                    <div class="ifb-tooltip">
                        <div class="ifb-tooltip-content">
                            ...
                            <code>%2$s = <?php esc_html_e('the token','vowels-contact-form-with-drag-and-drop'); ?></code><br />
