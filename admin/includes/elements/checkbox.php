...
$helpUrl = vowels_form_builder_help_link('element-checkbox');
?>
                ...
                <ul id="ifb_element_<?php echo $id; ?>" class="ifb-checkbox-option-list <?php echo ($element['options_layout'] == 'block') ? 'ifb-options-block' : 'ifb-options-inline'; ?> qfb-cf">
                    <?php if ($count) : ?>
                        <?php $i = 0; foreach ($element['options'] as $option) : ?>
                            <li><input type="checkbox" name="ifb_element_<?php echo $id; ?>" class="preview_form" disabled="disabled" value="<?php echo esc_attr($option['value']); ?>" <?php echo in_array($option['value'], $element['default_value'], true) ? 'checked="checked"' : ''; ?> /><label><?php echo $option['label']; ?></label></li>
                            <?php if ($i == 4) break; ?>
                        <?php $i++; endforeach; ?>
                    <?php endif; ?>
                </ul>
                        ...
                        <tr valign="top">
                            ...
                            <td>
                                <select name="convert_element_<?php echo $id; ?>" id="convert_element_<?php echo $id; ?>" onchange="vowelsforminc.convertElement(vowelsforminc.getElementById(<?php echo $id; ?>), this); ">
                                    ...
                                    <option value="radio"><?php esc_html_e('Multiple Choice','vowels-contact-form-with-drag-and-drop'); ?></option>
