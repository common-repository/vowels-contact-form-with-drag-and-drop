...
/**
 * vowelsforminc_Element_Groupstart
 *
 ...
 */
class vowelsforminc_Element_Groupstart extends vowelsforminc_Element
{
    /**
    ...
    {
        if ($colour) {
            $this->_borderColour = vowelsforminc::parseCss('border-color: ' . $colour . ';');
        } else {
    ...
    {
        if ($colour) {
            $this->_backgroundColour = vowelsforminc::parseCss('background-color: ' . $colour . ';');
        } else {
