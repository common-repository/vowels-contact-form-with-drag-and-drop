 ...
 */
class vowelsforminc_Element_Date extends vowelsforminc_Element
{
    /**
    ...
    {
        return strlen($this->_dayHeading) ? $this->_dayHeading : _x('Day', 'select day of the month','vowels-contact-form-with-drag-and-drop');
    }
    ...
    {
        return strlen($this->_monthHeading) ? $this->_monthHeading : _x('Month', 'select month','vowels-contact-form-with-drag-and-drop');
    }
    ...
    {
        return strlen($this->_yearHeading) ? $this->_yearHeading : _x('Year', 'select year','vowels-contact-form-with-drag-and-drop');
    }
    ...
    {
        return vowels_form_builder_get_start_year($this->_startYear);
    }
    ...
    {
        return vowels_form_builder_get_end_year($this->_endYear);
    }
