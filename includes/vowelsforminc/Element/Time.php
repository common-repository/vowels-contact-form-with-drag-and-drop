 ...
 */
class vowelsforminc_Element_Time extends vowelsforminc_Element
{
    /**
    ...
    public function getStartHour()
    {
        ...
        return apply_filters('vowels_form_builder_start_hour_' . $this->getName(), $startHour);
    }
    ...
    public function getEndHour()
    {
        ...
        return apply_filters('vowels_form_builder_end_hour_' . $this->getName(), $endHour);
    }
    ...
    {
        return strlen($this->_hhString) ? $this->_hhString : _x('HH', 'select hour','vowels-contact-form-with-drag-and-drop');
    }
    ...
    {
        return strlen($this->_mmString) ? $this->_mmString : _x('MM', 'select minute','vowels-contact-form-with-drag-and-drop');
    }
    ...
    {
        return strlen($this->_ampmString) ? $this->_ampmString : _x('am/pm', 'select morning/afternoon','vowels-contact-form-with-drag-and-drop');
    }
    ...
    {
        return strlen($this->_amString) ? $this->_amString : _x('am', 'time, morning','vowels-contact-form-with-drag-and-drop');
    }
    ...
    {
        return strlen($this->_pmString) ? $this->_pmString : _x('pm', 'time, evening','vowels-contact-form-with-drag-and-drop');
    }
