 ...
 */
class vowelsforminc_Element_File extends vowelsforminc_Element
{
    /**
     * File upload validator
     * @var vowelsforminc_Validator_FileUpload
     */
     ...
     * @var string
     */
    protected $_savePath = 'vowels/{form_id}/{year}/{month}/';
    ...
    public function __construct(array $config)
    {
        ...
        $this->_fileUploadValidator = new vowelsforminc_Validator_FileUpload(array(
            'name' => $this->getName()
        ));
     ...
     *
     * @return vowelsforminc_Validator_FileUpload
     */
    ...
    public function isValid()
    {
        ...
        $valid = apply_filters('vowels_form_builder_element_valid', $valid, null, $this);
        $valid = apply_filters('vowels_form_builder_element_valid_' . $this->getName(), $valid, null, $this);
    ...
    {
        return (strlen($this->_browseText)) ? $this->_browseText : _x('Browse...', 'for a file to upload','vowels-contact-form-with-drag-and-drop');
    }
    ...
    {
        return (strlen($this->_defaultText)) ? $this->_defaultText : __('No file selected','vowels-contact-form-with-drag-and-drop');
    }
