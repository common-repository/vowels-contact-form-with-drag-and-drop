...
/**
 * vowelsforminc_Validator_AlphaNumeric
 *
 ...
 */
class vowelsforminc_Validator_AlphaNumeric extends vowelsforminc_Validator_Abstract
{
    /**
    ...
    public function __construct($options = null)
    {
        $this->_messageTemplates = array(
            'invalid' => __('Only alphanumeric characters are allowed',  'vowels')
        );
    ...
    public function isValid($value)
    {
        ...
        $alphaNumericFilter = new vowelsforminc_Filter_AlphaNumeric();
