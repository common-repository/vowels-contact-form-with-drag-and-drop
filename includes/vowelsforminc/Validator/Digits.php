...
/**
 * vowelsforminc_Validator_Digits
 *
 ...
 */
class vowelsforminc_Validator_Digits extends vowelsforminc_Validator_Abstract
{
    /**
    ...
    public function __construct($options = null)
    {
        $this->_messageTemplates = array(
            'invalid' => __('Only digits are allowed',  'vowels')
        );
    ...
    public function isValid($value)
    {
        ...
        $digitsFilter = new vowelsforminc_Filter_Digits();
