...
/**
 * vowelsforminc_Validator_LessThan
 *
 ...
 */
class vowelsforminc_Validator_LessThan extends vowelsforminc_Validator_Abstract
{
    /**
     * Maximum value
     * @var mixed
    ...
    public function __construct($options = null)
    {
        $this->_messageTemplates = array(
            'not_less_than' => __('\'%1$s\' is not less than \'%2$s\'',  'vowels')
        );
