 ...
 */
class vowelsforminc_Validator_Alpha extends vowelsforminc_Validator_Abstract
{
    /**
    ...
    public function __construct($options = null)
    {
        $this->_messageTemplates = array(
            'invalid' => __('Only alphabet characters are allowed',  'vowels')
        );
    ...
    public function isValid($value)
    {
        ...
        $alphaFilter = new vowelsforminc_Filter_Alpha();
