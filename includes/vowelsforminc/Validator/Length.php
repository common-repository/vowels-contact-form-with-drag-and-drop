...
/**
 * vowelsforminc_Validator_Length
 *
 ...
 */
class vowelsforminc_Validator_Length extends vowelsforminc_Validator_Abstract
{
    /**
     * Minimum length
     * @var integer
    ...
    public function __construct($options = array())
    {
        $this->_messageTemplates = array(
            'invalid' => __('Invalid type given, value should be a string', 'vowels-contact-form-with-drag-and-drop'),
            'too_short' => __('Value must be at least %2$s characters long', 'vowels-contact-form-with-drag-and-drop'),
            'too_long' => __('Value must be no longer than %2$d characters','vowels-contact-form-with-drag-and-drop')
        );
