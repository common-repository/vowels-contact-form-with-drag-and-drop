...
/**
 * vowelsforminc_Validator_Identical
 *
 ...
 */
class vowelsforminc_Validator_Identical extends vowelsforminc_Validator_Abstract
{
    /**
     * The token to check
     * @var mixed
    ...
    public function __construct($spec)
    {
        $this->_messageTemplates = array(
            'not_match' => __('Value does not match',  'vowels')
        );
