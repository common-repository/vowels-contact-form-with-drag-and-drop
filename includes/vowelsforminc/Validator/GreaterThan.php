...
/**
 * vowelsforminc_Validator_GreaterThan
 *
 ...
 */
class vowelsforminc_Validator_GreaterThan extends vowelsforminc_Validator_Abstract
{
    /**
     * Minimum value
     * @var mixed
    ...
    public function __construct($options = null)
    {
        $this->_messageTemplates = array(
            'not_greater_than' => __('\'%1$s\' is not greater than \'%2$s\'',  'vowels')
        );
